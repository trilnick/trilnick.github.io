...
<a href="MCE-working-paper.pdf" onClick= "javascript: ga('send', 'event', 'Downloads', 'Download', 'MCE-paper-download', '1');" target="_blank">Working Paper <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
