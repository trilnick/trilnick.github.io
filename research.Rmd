...
How do California farmers deal with climate change? One adaptation technique, which we term Micro-Climate Engineering, is to change some local climate aspect affecting plants. We document a new potential approach for dealing with lowering winter chill in California, which is predicted to become a major problem for Pistachio growers. To reduce temperatures experienced by dormant trees, a mixture of very fine clay (Kaolin) is sprayed on dormant trees. We run market simulations, together with chill predictions from climate models for 2025-2050. The expected yearly welfare gains of using this technique are estimated at \$150 Million for pistachio alone. We suggest that Micro-Climate Engineering techniques will become a major adaptation approach for climate change.
