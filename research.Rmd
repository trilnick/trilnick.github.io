...
<a href="MCE-working-paper.pdf" onClick="ga('send', 'event', 'Downloads', 'Click', 'MCE_paper_download', '1');"  target="_blank">Working Paper <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
